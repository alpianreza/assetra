...
export default function App() {
  return <Providers><Toaster position="top-right" richColors /><Routes><Route path="/login" element={<LoginPage />} /><Route element={<AuthProvider><Layout /></AuthProvider>}><Route path="/" element={<HomePage />} /><Route path="/dashboard" element={<DashboardPage />} /><Route path="/inventory" element={<InventoryPage />} /><Route path="/inventory/new" element={<InventoryForm />} /><Route path="/inventory/:id" element={<InventoryDetail />} /><Route path="/inventory/:id/edit" element={<InventoryForm />} /><Route path="/inventory/:id/checklist-results/:occurrenceId" element={<ComplianceResultPage />} />
    <Route element={<MasterDataShell />}><Route path="/master-data" element={<MasterDataPage />} /><Route path="/master/areas" element={<AreasPage />} /><Route path="/master/categories" element={<CategoriesPage />} /><Route path="/master/item-types" element={<ItemTypesPage />} /><Route path="/checklist/templates" element={<ChecklistMasterPage />} /></Route>
